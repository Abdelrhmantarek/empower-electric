...
import { Car as CarIcon, Battery, ArrowRight, Gauge, Clock, Zap, LayoutGrid, RotateCw, Circle, CircleGauge, CirclePercent, ChevronRight } from "lucide-react";
      ...
      <div className="section-container">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mt-1">
            ...
            >
              ...
              <span className="text-muted-foreground text-lg">{car.specs.range} Range</span>
            </motion.div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 h-[70vh] min-h-[500px]">
              <ImageGallery 
                images={selectedColor ? [selectedColor.image, ...car.interior] : car.images} 
                alt={`${car.make} ${car.model}`} 
                isActive={viewMode === "photos"}
              />
              <CarSpinView
                carId={car.id}
                isActive={viewMode === "spin"}
              />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg mb-8">{car.description}</p>
                
                {/* Key Specifications Grid */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800 text-center">
                    <div className="text-2xl font-bold text-ev-blue mb-1">{car.year}</div>
                    <div className="text-sm text-muted-foreground">Year</div>
                  </div>
                  <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800 text-center">
                    <div className="text-2xl font-bold text-ev-blue mb-1">{car.specs.range}</div>
                    <div className="text-sm text-muted-foreground">Range</div>
                  </div>
                  <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800 text-center">
                    <div className="text-2xl font-bold text-ev-blue mb-1">{car.specs.acceleration}</div>
                    <div className="text-sm text-muted-foreground">0-60 mph</div>
                  </div>
                  <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800 text-center">
                    <div className="text-2xl font-bold text-ev-blue mb-1">{car.specs.seating}</div>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="text-center mb-8">
                  <div className="text-4xl font-bold text-ev-blue mb-2">{formattedPrice}</div>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <motion.div 
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: showSpecsAnimation ? 1 : 0, y: showSpecsAnimation ? 0 : 20 }}
            ...
            >
              ...
              <p className="text-3xl font-semibold text-foreground">{car.specs.range}</p>
            ...
            >
              ...
              <p className="text-3xl font-semibold text-foreground">{car.specs.acceleration}</p>
            ...
            >
              ...
              <p className="text-3xl font-semibold text-foreground">{car.specs.topSpeed}</p>
            ...
            >
              ...
              <p className="text-3xl font-semibold text-foreground">{car.specs.power}</p>
            ...
            >
              ...
              <p className="text-3xl font-semibold text-foreground">{car.specs.battery}</p>
            ...
            >
              ...
              <p className="text-3xl font-semibold text-foreground">{car.specs.seating}</p>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">Supercharger (150kW)</p>
                </div>
              ...
              <div className="mt-4 bg-ev-blue/5 p-4 rounded-lg">
                <p className="text-sm">Charge from 10% to 80% in just 30 minutes, adding up to 270 miles of range for your journey.</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">Wall Connector (11kW)</p>
                </div>
                <div className="flex items-baseline gap-1">
              ...
              <div className="mt-4 bg-ev-blue/5 p-4 rounded-lg">
                <p className="text-sm">Charge overnight from empty to full in 7 hours, perfect for daily commuting and electric lifestyle.</p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">Experience Electric Freedom</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              ...
              whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(0,98,204,0.15)" }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
            >
              ...
              <h3 className="text-xl font-semibold mb-3 relative">Rapid Charging</h3>
              <p className="text-muted-foreground relative">Charge up to 80% in just 30 minutes with fast-charging stations across the country.</p>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 relative">Long Range</h3>
              <p className="text-muted-foreground relative">Drive up to {car.specs.range} on a single charge, perfect for long trips and daily commutes.</p>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 relative">Instant Acceleration</h3>
              <p className="text-muted-foreground relative">Experience thrilling {car.specs.acceleration} acceleration with instant torque from the electric motors.</p>
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">Join the electric revolution with the {car.year} {car.make} {car.model}. Schedule a test drive today or request a personalized quote.</p>
