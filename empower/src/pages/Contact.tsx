      ...
      <div className="section-container">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Have questions about our electric vehicles or services? We're here to help you find the perfect EV for your needs.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-1">Sales: (555) 123-4567</p>
                  <p className="text-muted-foreground">Service: (555) 765-4321</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-1">Sales: sales@empowerev.com</p>
                  <p className="text-muted-foreground">Support: support@empowerev.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-ev-blue text-white p-3 rounded-full hover:bg-ev-blue-light transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ev-blue focus:border-transparent"
                        />
                      </div>
