...
export const cars: Car[] = [
  {
    ...
    mainImage: "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?q=80&w=1000&auto=format&fit=crop"
  },
  {
    id: "aurora-gt-2025",
    make: "Aurora",
    ...
    mainImage: "https://images.unsplash.com/photo-1553440569-bcc63803a83d?q=80&w=1000&auto=format&fit=crop"
  },
  {
    ...
    year: 2025,
    price: 42500,
    description: "The Quantum City combines efficiency with style in a compact electric vehicle that's perfect for urban driving. Despite its smaller footprint, this EV offers surprising interior space and comfort, with clever storage solutions throughout. With a range of 280 miles and nimble handling, it's designed to make city driving a pleasure. Smart features include autonomous parking, advanced driver assistance, and seamless connectivity with your digital life. The highly efficient battery system supports fast charging, getting you back on the road quickly.",
    shortDescription: "Compact urban electric vehicle with smart features and surprising interior space.",
    colors: [
      { 
        name: "Urban Gray", 
        value: "#808080", 
        image: "https://images.unsplash.com/photo-1593055357429-33f4e469504d?q=80&w=1000&auto=format&fit=crop" 
      },
      { 
        name: "Electric Yellow", 
        value: "#F9E430", 
        image: "https://images.unsplash.com/photo-1594639464720-28eb974c373e?q=80&w=1000&auto=format&fit=crop" 
      },
      { 
        name: "Ocean Teal", 
        value: "#008080", 
        image: "https://images.unsplash.com/photo-1637846896755-f3569ba7b3af?q=80&w=1000&auto=format&fit=crop" 
      },
    ],
    specs: {
      range: "280 miles",
    ...
    mainImage: "https://images.unsplash.com/photo-1593055357429-33f4e469504d?q=80&w=1000&auto=format&fit=crop"
  }
];
