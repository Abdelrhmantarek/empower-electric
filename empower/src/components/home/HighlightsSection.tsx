...
const carHighlights = [
  {
    ...
    description: "The future of electric SUVs with up to 400 miles of range and advanced AI assistance.",
    specs: {
      range: "400 miles",
  ...
  },
  {
    ...
    description: "Luxury electric sports car with stunning design and exhilarating performance.",
    specs: {
      range: "350 miles",
  ...
  },
  {
    ...
    description: "Compact urban electric vehicle with smart features and surprising interior space.",
    specs: {
      range: "280 miles",
...
export default function HighlightsSection() {
  ...
  return (
    <section className="w-full bg-gradient-to-br from-background via-background to-muted/20 overflow-hidden py-20">
                      ...
                      <div className="relative h-[30%] bg-gradient-to-br from-white via-white to-gray-50 dark:from-ev-charcoal dark:via-ev-gray-dark dark:to-black p-6 z-20">
                        <div className="flex flex-col h-full justify-between">
                          <div>
                            ...
                            <p className="text-ev-blue font-semibold text-sm">{car.lease}</p>
                          </div>
                        ...
                        <div className={cn(
                          ...
                          isActive ? "border-ev-accent shadow-[inset_0_0_20px_rgba(0,234,255,0.1)]" : "border-transparent"
                        )}></div>
                      </div>
                    </div>
                  </div>
