...
export default function QuoteModal({ car, isOpen, onClose }: QuoteModalProps) {
  ...
  useEffect(() => {
    if (isOpen) {
      // Get the current scroll position when opening the modal
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Backdrop positioned at user's current scroll */}
          <motion.div 
          ...
          >
            <motion.div 
              className="bg-background rounded-xl shadow-2xl w-full max-w-sm mx-auto overflow-hidden border border-border/30"
            ...
            >
              ...
              <div className="relative h-32 overflow-hidden">
                ...
                {/* Car details overlay */}
                <motion.div 
                  className={`absolute bottom-0 left-0 right-0 p-3 text-white ${textAlign}`}
              ...
              <div className="p-4">
                {isSubmitted ? (
                  ...
                  >
                    <motion.div 
                      className="rounded-full bg-green-100 p-3 mx-auto w-14 h-14 flex items-center justify-center"
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                          ...
                          <input
                            ...
                            type="text"
                            required
                            className={`w-full border rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-ev-blue focus:border-transparent ${textAlign} transition-all duration-200`}
                            value={formData.name}
                        ...
                        >
                          ...
                          <input
                            ...
                            type="email"
                            required
                            className={`w-full border rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-ev-blue focus:border-transparent ${textAlign}`}
                        ...
                        >
                          <label htmlFor="inquiryType" className="block text-xs font-medium mb-1">
                        ...
                        >
                          <button
                            ...
                            className={`button-primary w-full py-2 rounded-lg flex items-center justify-center gap-2 ${
