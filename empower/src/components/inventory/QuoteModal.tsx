...
const translations = {
  ...
  ar: {
    ...
    emailError: "فشل في إرسال إشعار البريد الإلكتروني.",
  },
};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_STRAPI_API_URL}/api/form-submissions`,
        {
          method: "POST",
          headers: {
      ...
      // Step 3: Update UI after successful submission
      ...
      setError(error.message || t.emailError);
      setIsSubmitting(false);
    }
  };
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ maxHeight: "calc(80vh - 8rem)", overflowY: "auto" }}
              >
                {isSubmitted ? (
                  <motion.div
                  ...
                  <>
                    ...
                    <form
                      ...
                      className={`${textAlign} space-y-2 sm:space-y-3`}
                    >
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                        ...
                        >
                          <label
                            htmlFor="name"
                            className={`block text-xs font-medium mb-0.5 text-gray-700 dark:text-gray-300 font-inter ${textAlign}`}
                          >
                          ...
                          >
                            {isSubmitting ? (
                              <span className="flex items-center justify-center">
                                <svg
                                  className="animate-spin -ml-1 mr-1 sm:mr-2 h-3 sm:h-4 w-3 sm:w-4 text-white dark:text-gray-100"
